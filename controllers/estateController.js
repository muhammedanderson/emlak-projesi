...
// 1. AŞAMA: Fiyat Hesaplama ve Rapor Sunumu (YAZDIRMA BUTONU EKLENDİ)
        ...
        if (totalUserListings >= 3) {
            return res.send(`
                <div style="font-family: Arial, sans-serif; padding: 40px; max-width: 550px; margin: 50px auto; border: 2px solid #e74c3c; border-radius: 12px; text-align: center; background:#fffcfc;">
                    ...
                    <p style="color: #666; margin-top:10px;">Daha fazla ilan eklemek için lütfen sisteme <b>Emlak Danışmanı</b> olarak kayıt olunuz.</p>
                    <br><br>
...
// YENİLENEN PAZARYERİ (ANLIK ARAMA VE FİLTRELEME MOTORU ENTEGRE EDİLDİ)
            ...
            <table id="marketTable" style="width: 100%; border-collapse: collapse; text-align: left; font-size:14px;">
                <thead>
                    <tr style="background: #f8fafc; border-bottom: 2px solid #cbd5e1;">
                        ...
                        <th style="padding:12px; color:#7f8c8d;">Ekspertiz Değeri</th>
